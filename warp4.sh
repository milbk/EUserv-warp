...
wget -N -6 https://gh.mili.one/github.com/ViRb3/wgcf/releases/latest/download/wgcf_2.2.3_linux_amd64
wget -N -6 https://gh.mili.one/github.com/bernardkkt/wg-go-builder/releases/latest/download/wireguard-go
